...
class MainWindow(QtWidgets.QMainWindow):
    ...
    def _build_ui(self):
        ...
        top_row.addWidget(save_group, stretch=1)
        ...
        top_row.addWidget(ros_group, stretch=1)
        ...
        preview_group.setMaximumHeight(360)
        ...
        calib_top.addWidget(QtWidgets.QLabel("角点列数(col)"), 0, 0)
        calib_top.addWidget(self.calib_cols, 0, 1)
        calib_top.addWidget(QtWidgets.QLabel("角点行数(row)"), 0, 2)
